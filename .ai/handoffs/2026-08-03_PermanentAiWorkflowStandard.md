# Handoff: Permanent AI workflow standard

**Date:** 2026-08-03  
**TaskName:** `PermanentAiWorkflowStandard`  
...
- Created `.ai/REPORT.md` and `.ai/handoffs/` archive (with README + this handoff).
...
| `.ai/REPORT.md` | Latest report |
| `.ai/handoffs/README.md` | Archive conventions |
| `.ai/handoffs/2026-08-03_PermanentAiWorkflowStandard.md` | This archive |
...
- Older handoffs for pre-`.ai` work were not backfilled; history before 2026-08-03 remains in git commits / PRs only.
- `PRODUCT_SPEC.md` status header may still be stale vs shipped app — out of scope here.
